...
def load_large_data(data_path, shuffle_index_path, adjacency_matrix_path):
    features = pd.read_csv(data_path, sep='\t', index_col=0, header=0)
    adj = sp.load_npz(adjacency_matrix_path)
    print(adj.shape)
    labels = features['iCluster']
    labels = labels - 1
    del features['iCluster']
    shuffle_index = pd.read_csv(shuffle_index_path, sep='\t', index_col=0, header=0)
    # print(shuffle_index.shape)
    
    return adj, np.asarray(features.T), labels.to_numpy(), shuffle_index.to_numpy()

# def load_large_data_2000(data_path = 'data/trimed_gene_expression_alternative_max2000.tsv' , net='biogrid', singleton=False):
#     features = pd.read_csv(data_path, sep='\t', index_col=0, header=0)
#     print(features.shape)
#     if net == 'biogrid':
#         adj = sp.load_npz('data/adj_matrix_max2000.npz')
#     elif net == 'string':
#         adj = sp.load_npz('data/adj_matrix_max2000_string.npz')
#     elif net == 'coexpression':
#         if singleton == False:
#             adj = sp.load_npz('data/adj_matrix_max2000_coexpression.npz')
#         else:
#             adj = sp.load_npz('data/adj_matrix_max2000_coexpression_w_singleton.npz')
#     else:
...
#     labels = labels - 1
#     del features['iCluster']
#     shuffle_index = pd.read_csv('data/shuffle_index_max2000.tsv', sep='\t', index_col=0, header=0)
#     # print(shuffle_index.shape)
    
#     return adj, np.asarray(features.T), labels.to_numpy(), shuffle_index.to_numpy()

# def load_large_data_5000(data_path = 'data/trimed_gene_expression_alternative_max5000.tsv' , net='biogrid', singleton=False):
#     features = pd.read_csv(data_path, sep='\t', index_col=0, header=0)
#     print(features.shape)
#     if net == 'biogrid':
#         adj = sp.load_npz('data/adj_matrix_max5000.npz')
#     elif net == 'string':
#         adj = sp.load_npz('data/adj_matrix_max5000_string.npz')
#     elif net == 'coexpression':
#         if singleton == False:
#             adj = sp.load_npz('data/adj_matrix_max5000_coexpression.npz')
#         else:
#             adj = sp.load_npz('data/adj_matrix_max5000_coexpression_w_singleton.npz')
#     else:
#         print('Invalid net value!')
#     print(adj.shape)
#     labels = features['iCluster']
#     labels = labels - 1
#     del features['iCluster']
#     shuffle_index = pd.read_csv('data/shuffle_index_max5000.tsv', sep='\t', index_col=0, header=0)
#     # print(shuffle_index.shape)
    
#     return adj, np.asarray(features.T), labels.to_numpy(), shuffle_index.to_numpy()

# def load_large_data_7000(data_path = 'data/trimed_gene_expression_alternative_max7000.tsv' , net='biogrid'):
#     features = pd.read_csv(data_path, sep='\t', index_col=0, header=0)
#     print(features.shape)
#     if net == 'biogrid':
#         adj = sp.load_npz('data/adj_matrix_max7000.npz')
#     elif net == 'string':
#         adj = sp.load_npz('data/adj_matrix_max7000_string.npz')
#     elif net == 'coexpression':
#         adj = sp.load_npz('data/adj_matrix_max7000_coexpression.npz')
#     else:
#         print('Invalid net value!')
#     print(adj.shape)
#     labels = features['iCluster']
#     labels = labels - 1
#     del features['iCluster']
#     shuffle_index = pd.read_csv('data/shuffle_index_max7000.tsv', sep='\t', index_col=0, header=0)
#     # print(shuffle_index.shape)
...
def removeZeroAdj(adj, train_data):
...
#    adjdense = adjdense[:, indd]
    train_data = train_data[:,indd]

    
    return adj, train_data
